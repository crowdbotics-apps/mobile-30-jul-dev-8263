...
function* newplugin304_get__readWorker(action) {
  try {
    const result = yield call(apiService.newplugin304_get__read, action)
    yield put(actions.newplugin304_get__readSucceeded(result))
  } catch (err) {
    yield put(actions.newplugin304_get__readFailed(err))
  }
}
function* newplugin304_get__readWatcher() {
  yield takeEvery(types.NEWPLUGIN304_GET__READ, newplugin304_get__readWorker)
}
function* newplugin303_get__readWorker(action) {
  try {
    const result = yield call(apiService.newplugin303_get__read, action)
    yield put(actions.newplugin303_get__readSucceeded(result))
  } catch (err) {
    yield put(actions.newplugin303_get__readFailed(err))
  }
}
function* newplugin303_get__readWatcher() {
  yield takeEvery(types.NEWPLUGIN303_GET__READ, newplugin303_get__readWorker)
}
function* newplugin301_get__readWorker(action) {
  try {
    const result = yield call(apiService.newplugin301_get__read, action)
    yield put(actions.newplugin301_get__readSucceeded(result))
  } catch (err) {
    yield put(actions.newplugin301_get__readFailed(err))
  }
}
function* newplugin301_get__readWatcher() {
  yield takeEvery(types.NEWPLUGIN301_GET__READ, newplugin301_get__readWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    newplugin304_get__readWatcher,
    newplugin303_get__readWatcher,
    newplugin301_get__readWatcher,
