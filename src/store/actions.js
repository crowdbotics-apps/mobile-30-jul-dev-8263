...
export const newplugin304_get__read = () => ({
  type: types.NEWPLUGIN304_GET__READ
})
export const newplugin304_get__readSucceeded = response => ({
  type: types.NEWPLUGIN304_GET__READ_SUCCEEDED,
  response
})
export const newplugin304_get__readFailed = error => ({
  type: types.NEWPLUGIN304_GET__READ_FAILED,
  error
})
